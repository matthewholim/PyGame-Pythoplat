...
#You're a king who rules over the tranquility kingdom. The evil fish emperor of the aquatic kingdrom has stolen your crown and you must go and retrieve it.
#----------------------------------------------------
...
bubble10.moveTo(1210,150)
bubble11.moveTo(1105,150)
bubble12.moveTo(1140,150)
...
itemb4.moveTo(1210,200)
itemb5.moveTo(1105,200)
itemb6.moveTo(1140,200)
...
#    if fish.x<=460:
 #       fish.moveTo(580,580)
    ...
    if king.collidedWith(spike) or king2.collidedWith(spike2)or king2.collidedWith(spike) or king.collidedWith(spike2):
        ...
        king2.moveTo(brick38.x,695)
    if king.health<=60:
        bubble4.moveTo(bubble3.x,bubble3.y)
    ...
    if king.collidedWith(spike) or king2.collidedWith(spike2)or king2.collidedWith(spike) or king.collidedWith(spike2):
        ...
        king2.moveTo(brick38.x,695)
    if king.health<=40:
        bubble.moveTo(bubble3.x,bubble3.y)


    if bubble.isOffScreen("all") and bubble4.isOffScreen("all") and bubble3.isOffScreen("all"):
        game.over = True
        gameover.draw()

    if king.collidedWith(door)and key2.y<=30 and keys.Pressed[K_s]:
        game.over = True
        win.draw()
    if king2.collidedWith(door) and key2.y<=30 and keys.Pressed[K_s]:
        game.over =True
        win.draw()
